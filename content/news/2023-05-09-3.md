---
title: "Graduated with a Bachelors in Electronics and Communication Engineering!"
date: 2023-05-09
category: education
---
...
<table>
  <tr>
    <td>
        <div style="text-align: center;">
            <img src="/img/BestProjectAward.jpg" alt="Best Project Award" width="300">
            <p>Best Project Award</p>
        </div>
    </td>
    <td>
        <div style="text-align: center;">
            <img src="/img/Best Project Award Certificate.jpg" alt="Best Project Award Certificate" width="400">
  ...
  <tr>
    <td>
        <div style="text-align: center;">
            <img src="/img/ScholarshipCertificate.jpg" alt="Scholarship Certificate" width="400">
            <p>Scholarship Certificate</p>
        </div>
    </td>
    <td>
        <div style="text-align: center;">
            <img src="/img/HighCGPARecognitionCertificatewithMedal.jpg" alt="Certificate of Recognition" width="400">
